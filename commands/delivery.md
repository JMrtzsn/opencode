...
Create draft pull requests unless the user explicitly requests otherwise. Use plain imperative titles without conventional-commit prefixes. Keep descriptions minimal and ask the user what they should contain when unclear.
